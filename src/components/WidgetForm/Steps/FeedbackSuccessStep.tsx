...
export function FeedbackSuccessStep({ onFeedbackRestartRequest, language }: FeedbackSuccessStepProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-8 md:py-10 w-full max-w-[304px] px-2">
        ...
        <span className="text-lg md:text-xl mt-2 text-center">{t.success.message}</span>
